...
import { UserNotificationTime as BaseModel } from "../../models/User";
import BaseDAL from "../Base.dal";

class UserNotificationTimeDAL {
  /**
   *
   *
   * @static
   ...
   * @param {Transaction} t
   * @memberof UserNotificationTimeDAL
   */
  static create = (
...
export default UserNotificationTimeDAL;
