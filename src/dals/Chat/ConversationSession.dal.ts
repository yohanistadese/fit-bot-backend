...
import { ConversationSession as BaseModel } from "../../models/Chat";
import BaseDAL from "../Base.dal";

class ConversationSessionDAL {
  /**
   *
   *
   * @static
   ...
   * @param {Transaction} t
   * @memChatTunef ConversationSessionDAL
   */
  static create = (
...
export default ConversationSessionDAL;
